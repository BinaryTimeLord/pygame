...
class StartScreen(state.State):
    def __init__(self, game):
        ...
        self.starttext_2 = self.game.small_font.render("Controls wasd", True, (128,128,128))
        self.starttext_3 = self.game.small_font.render("Space to Jump/Confirm", True, (128,128,128))
        self.starttext_4 = self.game.small_font.render("Enter to Pause", True, (128,128,128))
        self.starttextrect = self.starttext.get_rect(center=(self.game.screen_width / 2, self.game.screen_height / 2 - 45))
        self.starttextrect_2 = self.starttext_2.get_rect(center=(self.game.screen_width / 2, self.game.screen_height / 2 - 15))
        self.starttextrect_3 = self.starttext_3.get_rect(center=(self.game.screen_width / 2, self.game.screen_height / 2 + 15))
        self.starttextrect_4 = self.starttext_4.get_rect(center=(self.game.screen_width / 2, self.game.screen_height / 2 + 45))
    ...
    def render(self):
        ...
        tempsurf.blit(self.starttext_2, self.starttextrect_2)
        tempsurf.blit(self.starttext_3, self.starttextrect_3)
        tempsurf.blit(self.starttext_4, self.starttextrect_4)
        tempsurf.blit(self.starttext,self.starttextrect)
